"""
Django settings for innocelf project.
...
SECRET_KEY = 'xp^sy0fk5u%c*3ja5cdwwf7xk$$ssry1(+xerls6x6h-q4vxh&'
...
WSGI_APPLICATION = 'innocelf.wsgi.application'
...
# Media Files (user uploaded documents, images and such)
MEDIA_URL = '/media/'
